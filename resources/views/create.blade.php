...
<body>
                ...
                <div class="col-md-6">
                  ...
                  >
                    <div
                      ...
                      style="
                        background-image: url('./img/img12new.jpg');
                  ...
                  <div class="card card-plain mt-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                          <button
                            type="submit"
                            class="btn btn-custom btn-dark w-100 mt-4 mb-3"
                          >
                            Sign up
                          </button>
                          <!-- <button
                          ...
                          >
                            <span class="btn-inner--icon me-1">
                              <img
                                class="w-5"
                                src="https://demos.creative-tim.com/corporate-ui-dashboard/assets/img/logos/google-logo.svg"
                                alt="google-logo"
                              />
                            </span>
    ...
    <script>
        ...
        const fruits = ["Apple", "Banana", "Cherry", "Mango", "Pear", "Grape"];
